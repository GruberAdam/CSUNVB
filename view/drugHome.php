            ...
            <tbody ><tr >
                ...
                for($compteur=1;$compteur<14;$compteur++){
                    ...
                    if ($compteur==$compteur3){
                        ...
                        echo " <th  id='rowh1cel$compteur3' height='100' colspan='4' class='col-xs-12  col-md-12 col-lg-12 center'>". strftime("%A", mktime(0, 0, 0, 0 ,  $dateday, 0 ))  .  strftime(" %d %B %Y", mktime(0, 0, 0,$datemonth , idate("W") + $dateday , $dateyear )). "</th>";
                        $dateday++;
