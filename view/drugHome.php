    ...
    <form method="post" action="index.php?action=finish">
        ...
        <table class=" ">
            ...
            <tbody ><tr >
                ...
                for($compteur=1;$compteur<14;$compteur++){
                    ...
                    if ($compteur==$compteur3){
                        ...
                        echo " <th  id='rowh1cel$compteur3' height='100' colspan='4' class='col-xs-12  col-md-12 col-lg-12 center'>". strftime("%A", mktime(0, 0, 0, 0 , $dateday2 + $dateday, 0 ))  .  strftime(" %d %B %Y", mktime(0, 0, 0,$datemonth , idate("W") + $dateday , $dateyear )). "</th>";
                        $dateday++;
            ...
            <tr>
                ...
                echo "<td id='h2cel0' class='cel0'><p id='ph2cel$compteur' class=' col-xs-12  col-md-12 col-lg-12 input'></p></td>";
                for($compteur2=1;$compteur2<23;$compteur2++){



                    if($compteur2 == $compteur8) {
                        echo "<td id='h2cel$compteur2' class='celsmall' ><p id='ph2cel$compteur' class= 'col-xs-12  col-md-12 col-lg-12 input'  >pharma</p></td>";
                        if($compteur2 == $compteur8 && ($compteur2 != 1 && $compteur2 != 22)) {
                            echo "<td id='h2cel{$compteur2}2' class='celsmall' ><p id='ph2cel$compteur' class='col-xs-12  col-md-12 col-lg-12 input'  >pharma</p></td>";

                        }
                        $compteur8 = $compteur8 + 3;
                    }else{
                        echo "<td id='h2cel$compteur2'><input type='text' name='inputph2cel{$compteur}'  class='col-xs-12  col-md-12 col-lg-12 input' value=''></td>";
                    }
