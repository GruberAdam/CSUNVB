    ...
    <form action="index.php">
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="responsabledejour" placeholder="Responsable de jour"
                       required>
            </div>
            <!-- Responsable de nuit -->
            <div class="col-md-4 mb-3">
                <label for="responsabledenuit">Responsable de nuit</label>
                <input type="text" class="form-control" id="responsabledenuit" placeholder="Responsable de nuit"
                       required>
            </div>
            <!-- Équipage de jour -->
            <div class="col-md-4 mb-3">
