...
<div class="row m-2">
    ...
    <form method="post" action="index.php?action=finish">
        ...
        <table class=" ">
            ...
            echo " <th  id='rowh1cel$compteur3' height='100' colspan='4' class=''>". strftime("%A", mktime(0, 0, 0, 0 ,  $dateday, 0 ))  .  strftime(" %d %B %Y", mktime(0, 0, 0,$datemonth , idate("W") + $dateday - 1 , $dateyear )). "</th>";
